...
public class AppMain extends JFrame implements ActionListener{
	...
	JLabel la_dest; //어느 경로로 저장할지 정보 출력할 영역
	...
	public AppMain() {
		...
		la_dest=new JLabel("저장할 위치를 등록해주세요");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==bt_dest) {
			...
			thread.start(); // 다운로드 버튼을 누를 때마다 thread가 생성되는 것. 소모적인 요소기 때문에 thread는 생성 후 } 닫는 브레이스 만나 소멸될 것.
		}
	}
